...
/**
 * @Author: Mr Liu Meng
 * @Date : 15:54 2020/10/27
 * @Description：
 */
public class Solution_innerClass {
        public static void dfs(List<Integer> cur_val, int t, List<List<Integer>> res, int[] candidates){
    ...
    public static void  main(String[] args){
        ...
        int target=8;
        Solution_innerClass s=new Solution_innerClass();
